...
namespace model
{
    ...
    {
        Q_OBJECT
        Q_PROPERTY(QString customScript MEMBER _customScript READ getCustomScript WRITE setCustomScript)
        Q_PROPERTY(int executionCondition MEMBER _executionCondition READ getExecutionCondition WRITE setExecutionCondition)
        Q_PROPERTY(quint64 deltaDelay MEMBER _deltaDelay READ getDeltaDelay WRITE setDeltaDelay)
        Q_PROPERTY(QString externalGraphId MEMBER _externalGraphId READ getExternalGraphId WRITE setExternalGraphId)
        Q_PROPERTY(QString externalNodeId MEMBER _externalNodeId READ getExternalNodeId WRITE setExternalNodeId)
    public:
